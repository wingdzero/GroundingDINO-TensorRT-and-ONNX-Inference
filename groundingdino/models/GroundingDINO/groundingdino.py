...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, 
        ...
        bert_output = self.bert(**tokenized_for_encoder)  # bs, 195, 768, 用于onnx
        # bert_output = self.bert(input_ids=input_ids, attention_mask=text_self_attention_masks,
        #                         position_ids=position_ids, token_type_ids=token_type_ids)  # bs, 195, 768, 用于torchscript
